...
class DestinationController extends Controller
{
    ...
    public function store(DestinationRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('backsite.destination.index')->withSuccess('Berhasil menambah data!');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function update(DestinationRequest $request, $id)
    {
        ...
        DB::beginTransaction();
        try {
            $data = Destination::findOrFail($id); // Pastikan data ditemukan, jika tidak maka gagal langsung
            ...
            return redirect()->route('backsite.destination.index')->withSuccess('Berhasil merubah data!');
        } catch (\Exception $e) {
            DB::rollBack();
            Log::error("ERROR APP : " . $e->getMessage());
