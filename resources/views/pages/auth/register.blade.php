                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('register.store') }}" method="POST">
                            ...
                            <fieldset class="form-group position-relative has-icon-left">
                                <input name="nama_lengkap" type="text" class="form-control" id="user-name" placeholder="Nama Lengkap">
                            ...
                            <fieldset class="form-group position-relative has-icon-left">
                                <input name="password_confirmation" type="password" class="form-control" id="user-password" placeholder="Konfirmasi Password" required>
                                <div class="form-control-position">
                                    <i class="la la-key"></i>
                                </div>
                            </fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-12 float-sm-left text-center text-sm-right"><a href="{{ route('recover') }}" class="car-link">Forgot Password?</a></div>
                            </div>
                            <button type="submit" class="btn btn-outline-info btn-block"><i class="la la-user">Register</i></button>
                        </form>
                    </div>
                    <div class="card-body">
                        <a href="{{ route('login.index') }}" class="btn btn-outline-danger btn-block"><i class="ft-unlock"></i>
                            Login</a>
                    </div>
                </div>
            </div>
