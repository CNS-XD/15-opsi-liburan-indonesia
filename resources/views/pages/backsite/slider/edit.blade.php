...
@section('activeMenuSlider', 'active open')
@section('activeSubMenuSlider', 'active open')

{{-- Breadcrumb --}}
@section('breadcrumb1', 'Slider')
@section('breadcrumb2', 'Edit')

{{-- Button Pojok Kanan --}}
@section('buttonRight')
<a href="{{ route('backsite.slider.index') }}" class="btn btn-danger btn-glow round">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal form-bordered" enctype="multipart/form-data"
                                action="{{ route('backsite.slider.update', $data->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 pl1-2 pr1-2 mx-auto">
                                                    <input type="text" name="title" class="form-control" value="{{ $data->title }}" placeholder="Ex: Hassle Free" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 p-0">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 pl1-2 pr1-2 mx-auto">
                                                    <textarea name="description" class="form-control" placeholder="Ex: We work to simplify your journey. Saving your time & mind, just enjoy the experience." cols="10" rows="4">{{ $data->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
