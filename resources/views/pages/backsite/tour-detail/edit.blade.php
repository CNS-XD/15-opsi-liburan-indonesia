...
@section('title', 'Edit Tour Detail')
@section('activeMenuTour', 'active open')
@section('activeSubMenuTourDetail', 'active open')

{{-- Breadcrumb --}}
@section('breadcrumb1', $data->title)
@section('breadcrumb2', 'Edit Tour Detail')

{{-- Button Pojok Kanan --}}
@section('buttonRight')
<a href="{{ route('backsite.tour-detail.index', $data->id_tour) }}" class="btn btn-danger btn-glow round">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal form-bordered" enctype="multipart/form-data"
                                action="{{ route('backsite.tour-detail.update', $data->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
...
@push('after-script')
<script>
    $('.summernote-tour-detail').summernote({
        height: 300,
        toolbar: [
