...
@section('title', 'Blog')
@section('activeMenuBlog', 'open active')
@section('activeSubMenuBlog', 'open active')
...
{{-- Button Pojok Kanan --}}
@section('buttonRight')
<a href="{{ route('backsite.blog.create') }}" class="btn btn-success btn-sm btn-glow round">
    <i class="fa fa-plus"></i> Add
</a>
<a href="{{ route('backsite.blog.index') }}" class="btn btn-info btn-sm btn-glow round" target="_blank">
...
<script>
    ...
    const datatable = () => {
        ...
        $('#dataTable').DataTable({
            ...
            "ajax": {
                url: '{{ route('backsite.blog.datatable') }}',
            },
            columns: [
                {
                    data: 'DT_RowIndex',
    ...
    function setShow(id) {
        ...
        let url = `{{ route('backsite.blog.set-show', ':id') }}`;
    ...
    // Delete
    const deleteRoute = "{{ route('backsite.blog.destroy', ':id') }}";
