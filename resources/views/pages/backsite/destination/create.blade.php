                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal form-bordered"
                                action="{{ route('backsite.destination.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 p-0">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 pl1-2 pr1-2 mx-auto">
                                                    <input type="text" name="province" class="form-control" placeholder="ex: East Java, Bali, Central Java, West Java, etc" value="{{ old('province') }}" />
