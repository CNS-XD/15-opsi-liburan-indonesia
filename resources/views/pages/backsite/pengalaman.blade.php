...
@section('activePengalaman', 'active')
    ...
    <div class="content-header-light col-12">
        <div class="row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <h3 class="content-header-title">Pengalaman</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ asset('backsite.dashboard') }}">Profil</a>
                            </li>
                            <li class="breadcrumb-item active">Pengalaman
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section id="timeline" class="timeline-right timeline-wrapper">
            ...
            <ul class="timeline">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <img class="img-fluid" src="{{ asset('backsite-assets/app-assets/images/portfolio/width-1200/portfolio-2.jpg') }}" alt="Timeline Image 1">
                                        ...
                                        <div class="media">
                                            <div class="media-left pr-1">
                                                <a href="#">
                                                    <span class="avatar avatar-online"><img src="{{ asset('backsite-assets/app-assets/images/portrait/small/avatar-s-2.png') }}" alt="avatar"></span>
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                ...
                                                <div class="media">
                                                    <div class="media-left pr-1">
                                                        <a href="#">
                                                            <span class="avatar avatar-online"><img src="{{ asset('backsite-assets/app-assets/images/portrait/small/avatar-s-18.png') }}" alt="avatar"></span>
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <img class="img-fluid" src="{{ asset('backsite-assets/app-assets/images/portfolio/width-1200/portfolio-3.jpg') }}" alt="Timeline Image 1">
                                        <p class="card-text">Nullam facilisis fermentum aliquam. Suspendisse ornare dolor vitae libero hendrerit auctor lacinia a ligula. Curabitur elit tellus, porta ut orci sed, fermentum bibendum nisi.</p>
                                        <ul class="list-inline mb-0">
                                            <li class="pr-1"><a href="#" class="text-muted"><span class="la la-heart-o"></span> Like</a></li>
                                            <li class="pr-1"><a href="#" class="text-muted"><span class="la la-comments-o"></span> Comment</a></li>
                                        ...
                                        <div class="media">
                                            <div class="media-left pr-1">
                                                <a href="#">
                                                    <span class="avatar avatar-online"><img src="{{ asset('backsite-assets/app-assets/images/portrait/small/avatar-s-3.png') }}" alt="avatar"></span>
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <p class="text-bold-600 mb-0"><a href="#">Jason Ansley</a></p>
                    ...
                    <div class="timeline-card card border-grey border-lighten-2">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <img class="img-fluid" src="{{ asset('backsite-assets/app-assets/images/portfolio/width-1200/portfolio-1.jpg') }}" alt="Timeline Image 1">
                                        <p class="card-text">Nullam facilisis fermentum aliquam. Suspendisse ornare dolor vitae libero hendrerit auctor lacinia a ligula. Curabitur elit tellus, porta ut orci sed, fermentum bibendum nisi.</p>
                                        <ul class="list-inline mb-0">
                                            <li class="pr-1"><a href="#" class="text-muted"><span class="la la-heart-o"></span> Like</a></li>
                                            <li class="pr-1"><a href="#" class="text-muted"><span class="la la-comments-o"></span> Comment</a></li>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="media">
                                            <div class="media-left pr-1">
                                                <a href="#">
                                                    <span class="avatar avatar-online"><img src="{{ asset('backsite-assets/app-assets/images/portrait/small/avatar-s-1.png') }}" alt="avatar"></span>
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <p class="text-bold-600 mb-0"><a href="#">Jason Ansley</a></p>
                ...
                <li class="timeline-item mt-3">
                    <div class="timeline-badge">
                        <span class="avatar avatar-online" data-toggle="tooltip" data-placement="left" title="Eu pid nunc urna integer"><img src="{{ asset('backsite-assets/') }}app-assets/images/portrait/small/avatar-s-14.png" alt="avatar"></span>
                    </div>
                    <div class="timeline-card card border-grey border-lighten-2">
                        <div class="card-header">
            ...
            <ul class="timeline">
                ...
                <li class="timeline-item">
                    <div class="timeline-badge">
                        <span class="avatar avatar-online" data-toggle="tooltip" data-placement="left" title="Eu pid nunc urna integer"><img src="{{ asset('backsite-assets/') }}app-assets/images/portrait/small/avatar-s-5.png" alt="avatar"></span>
                    </div>
                    <div class="row match-height">
                        <div class="col-lg-8 col-12">
                            <div class="timeline-card card bg-dark text-white">
                                <img class="card-img img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/portfolio/width-1200/portfolio-2.jpg" alt="Card image">
                        ...
                        <div class="card-body my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                            <div class="row">
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/1.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/1.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/2.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/2.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/3.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/3.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/4.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/4.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                            </div>
                            <div class="row">
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/5.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/5.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/6.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/6.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/7.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/7.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/8.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/8.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                            </div>
                            <div class="row">
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/9.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/9.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/10.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/10.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/11.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/11.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                                <figure class="col-md-3 col-sm-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="{{ asset('backsite-assets/') }}app-assets/images/gallery/12.jpg" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ asset('backsite-assets/') }}app-assets/images/gallery/12.jpg" itemprop="thumbnail" alt="Image description" />
                                    </a>
                                </figure>
                            </div>
                        </div>
