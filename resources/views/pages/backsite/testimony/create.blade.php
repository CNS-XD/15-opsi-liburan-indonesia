                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal form-bordered" enctype="multipart/form-data"
                                action="{{ route('backsite.testimony.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 pl1-2 pr1-2 mx-auto">
                                                    <textarea name="description" class="form-control summernote-testimony" cols="30" rows="10">{{ old('description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
...
@push('after-script')
<script>
    $('.summernote-testimony').summernote({
        height: '300px',
        toolbar: [
