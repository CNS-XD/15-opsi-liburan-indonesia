                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-headingThree">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="flush-collapseThree">How do I book a tour or vacation package?</button>
                                </h5>
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-headingFive">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="flush-collapseFive">Do you provide travel insurance options?</button>
                                </h5>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample2">
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-visa-headingOne">
                                    <button class="accordion-button" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#flush-visa-collapseOne"
                                        aria-expanded="false" aria-controls="flush-visa-collapseOne">Do I need a visa for my destination?</button>
                                </h5>
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-visa-headingTwo">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#flush-visa-collapseTwo"
                                        aria-expanded="false" aria-controls="flush-visa-collapseTwo">What documents are required for visa processing?</button>
                                </h5>
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-visa-headingThree">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#flush-visa-collapseThree"
                                        aria-expanded="false" aria-controls="flush-visa-collapseThree">How long does visa approval take?</button>
                                </h5>
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-visa-headingFour">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#flush-visa-collapseFour"
                                        aria-expanded="false" aria-controls="flush-visa-collapseFour">Can you assist with passport renewals?</button>
                                </h5>
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                <h5 class="accordion-header" id="flush-visa-headingFive">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#flush-visa-collapseFive"
                                        aria-expanded="false" aria-controls="flush-visa-collapseFive">What happens if my visa is rejected?</button>
                                </h5>
