                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/1.jpg" alt="" style="height:250px; width:100%">
                                    </a>
                                    <div class="batch">
                                ...
                                <div class="package-content">
                                    <h5><a href="javascript:void(0);">Mount Bromo Sunrise and Madakaripura Waterfall Tour Package from Surabaya - 1 Day</a></h5>
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    <div class="swiper package-card-img-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0);" class="package-img">
                                                    <img src="/frontsite-assets/img/packages/2.jpg" alt="" style="height:250px; width:100%">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0);" class="package-img">
                                                    <img src="/frontsite-assets/img/packages/7.jpg" alt="" style="height:250px; width:100%">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0);" class="package-img">
                                                    <img src="/frontsite-assets/img/packages/3.jpg" alt="" style="height:250px; width:100%">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="package-content">
                                    <h5><a href="javascript:void(0);">Mount Bromo and Madakaripura Waterfall Overnight Tour Package from Malang - 2 Days</a></h5>
                                    <div class="location-and-time">
                                        <div class="location">
                                            <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/5.jpg" alt="" style="height:250px; width:100%">
                                    </a>
                                </div>
                                <div class="package-content">
                                    <h5><a href="javascript:void(0);">Bromo Sunrise - Madakaripura Waterfall - Ijen Blue Fire 3D Tour Package from Yogyakarta - 3 Days</a></h5>
                                    <div class="location-and-time">
                                        <div class="location">
                                            <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/9.jpg" alt="" style="height:250px; width:100%">
                                    </a>
                                    <div class="batch">
                                        <span>Most Loved</span>
                                    </div>
                                ...
                                <div class="package-content">
                                    <h5><a href="javascript:void(0);">Mt. Bromo, Ijen Blue Fire, & Tumpak Sewu Waterfall Tour Package from Surabaya - 4 Days</a></h5>
                                    <div class="location-and-time">
                                        <div class="location">
                                            <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/4.jpg" alt="" style="height:250px; width:100%">
                                    </a>
                                </div>
                                <div class="package-content">
                                    <h5><a href="javascript:void(0);">Tumpak Sewu Waterfall and Jodipan Rainbow Village Tour Package from Surabaya - 1 Day</a></h5>
                                    <div class="location-and-time">
                                        <div class="location">
                                            <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <path
