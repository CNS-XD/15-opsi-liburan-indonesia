    ...
    <div class="container">
        <div class="service-wrapper two">
            ...
            <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                @forelse($advantages->take(3) as $index => $advantage)
                    <li class="single-service">
                        <div class="icon {{ $index % 2 == 0 ? 'bg-info' : 'bg-warning' }}">
                            @if($advantage->icon && file_exists(public_path('storage/' . $advantage->icon)))
                                <img src="{{ asset('storage/' . $advantage->icon) }}" alt="{{ $advantage->title }}" width="30" height="30">
                            @else
                                @if($index == 0)
                ...
                @empty
                    <!-- Default advantages jika tidak ada data -->
                    <li class="single-service">
            ...
            <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                @forelse($advantages->skip(3)->take(3) as $index => $advantage)
                <li class="single-service">
                    <div class="icon {{ ($index + 3) % 2 == 0 ? 'bg-info' : 'bg-warning' }}">
                        @if($advantage->icon && file_exists(public_path('storage/' . $advantage->icon)))
                            <img src="{{ asset('storage/' . $advantage->icon) }}" alt="{{ $advantage->title }}" width="30" height="30">
                        @else
                            @if($index == 0)
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="{{ route('frontsite.destinations.show', $destination->id) }}" class="destination-img">
                                @if($destination->image && file_exists(public_path('storage/' . $destination->image)))
                                    <img src="{{ asset('storage/' . $destination->image) }}" style="height: 400px; width: 100%" alt="{{ $destination->title }}">
                                @else
                                    <img src="{{ asset('frontsite-assets/img/packages/' . (($loop->index % 13) + 1) . '.jpg') }}" style="height: 400px; width: 100%" alt="{{ $destination->title }}">
                                @endif
                            </a>
                            <div class="destination-content">
                                <h5><a href="{{ route('frontsite.destinations.show', $destination->id) }}">{{ $destination->title }}</a></h5>
                                <span>Tours ({{ $destination->tour_destinations_count ?? 0 }})</span>
                            </div>
                        </div>
                    </div>
                    @empty
...
<div class="home2-oneday-trip-section mb-100">
    <div class="container">
        ...
        <div class="row g-4 mb-40">
            @forelse($oneDayTours->take(3) as $index => $tour)
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="{{ 200 + ($index * 200) }}ms" data-wow-duration="1500ms">
                    <div class="package-card">
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ route('frontsite.tours.show', $tour->slug) }}" class="package-img">
                                                    @if($photo->image && file_exists(public_path('storage/' . $photo->image)))
                                                        <img src="{{ asset('storage/' . $photo->image) }}" style="height: 300px; width: 100%; object-fit: cover;" alt="{{ $tour->title }}">
                                                    @else
                        ...
                        <div class="package-content">
                            <h5><a href="{{ route('frontsite.tours.show', $tour->slug) }}">{{ $tour->title }}</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    ...
                                    @if($tour->tour_departures->count() > 0)
                                        <a href="{{ route('frontsite.tours.show', $tour->slug) }}">from {{ $tour->tour_departures->first()->departure->title ?? 'Various Cities' }}</a>
                                    @else
                                        <a href="{{ route('frontsite.tours.show', $tour->slug) }}">Various Departure Points</a>
                                    @endif
                                </div>
                            </div>
                            <div class="btn-and-price-area">
                                <a href="{{ route('frontsite.tours.show', $tour->slug) }}" class="primary-btn1">
                                    <span>
                                        Book Now
                                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div class="price-area">
                                    <h6>Per Person</h6>
                                    @if($tour->tour_prices->count() > 0)
                                        <span>${{ number_format($tour->tour_prices->min('price'), 0) }}</span>
                                    @else
                            ...
                            <div class="bottom-area">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        {{ $tour->day_tour }} Day{{ $tour->day_tour > 1 ? 's' : '' }}
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            @empty
                <!-- Fallback content when no one day tours exist -->
                    ...
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="javascript:void(0);" class="package-img">
                                <img src="/frontsite-assets/img/packages/9.jpg" style="height: 300px; width: 100%; object-fit: cover;" alt="Sample Tour">
                            </a>
                            <div class="batch">
                                <span>Most Loved</span>
                            </div>
                        ...
                        <div class="package-content">
                            <h5><a href="javascript:void(0);">Sample One Day Tour Package</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="javascript:void(0);">Various Cities</a>
                                </div>
                            </div>
                            <div class="btn-and-price-area">
        ...
        <div class="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="{{ route('frontsite.tours.index') }}" class="primary-btn1 transparent">
                    <span>
                        View All Trips
                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="container">
        ...
        <div class="row g-4 mb-40">
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="blog-card2">
                    <div class="blog-img-wrap">
                        <a href="{{ isset($blogs[0]) ? route('frontsite.news.show', $blogs[0]->id) : 'javascript:void(0);' }}" class="blog-img">
                            @if(isset($blogs[0]) && $blogs[0]->image && file_exists(public_path('storage/' . $blogs[0]->image)))
                                <img src="{{ asset('storage/' . $blogs[0]->image) }}" alt="{{ $blogs[0]->title }}" style="min-height: 250px; object-fit: cover;">
                            @else
                                <img src="/frontsite-assets/img/packages/3.png" alt="" style="min-height: 250px">
                            @endif
                        </a>
                        <a href="{{ isset($blogs[0]) ? route('frontsite.news.show', $blogs[0]->id) : 'javascript:void(0);' }}" class="blog-date">
                            @if(isset($blogs[0]))
                                {{ \Carbon\Carbon::parse($blogs[0]->created_at)->format('d') }} <span>{{ \Carbon\Carbon::parse($blogs[0]->created_at)->format('M') }}.</span>
                            @else
                                02 <span>Jan.</span>
                            @endif
                        </a>
                    ...
                    <div class="blog-content">
                        <a href="{{ isset($blogs[0]) ? route('frontsite.news.show', $blogs[0]->id) : 'javascript:void(0);' }}" class="location">
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="blog-card2">
                    <div class="blog-img-wrap">
                        <a href="{{ isset($blogs[1]) ? route('frontsite.news.show', $blogs[1]->id) : 'javascript:void(0);' }}" class="blog-img">
                            @if(isset($blogs[1]) && $blogs[1]->image && file_exists(public_path('storage/' . $blogs[1]->image)))
                                <img src="{{ asset('storage/' . $blogs[1]->image) }}" alt="{{ $blogs[1]->title }}" style="min-height: 250px; object-fit: cover;">
                            @else
                                <img src="/frontsite-assets/img/packages/2.png" alt="" style="min-height: 250px">
                            @endif
                        </a>
                        <a href="{{ isset($blogs[1]) ? route('frontsite.news.show', $blogs[1]->id) : 'javascript:void(0);' }}" class="blog-date">
                            @if(isset($blogs[1]))
                                {{ \Carbon\Carbon::parse($blogs[1]->created_at)->format('d') }} <span>{{ \Carbon\Carbon::parse($blogs[1]->created_at)->format('M') }}.</span>
                            @else
                                04 <span>Feb.</span>
                            @endif
                        </a>
                    ...
                    <div class="blog-content">
                        <a href="{{ isset($blogs[1]) ? route('frontsite.news.show', $blogs[1]->id) : 'javascript:void(0);' }}" class="location">
                            <svg width="14" height="16" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M6.81276 0C3.31734 0 0.473053 2.84433 0.473053 6.34163C0.473053 9.07242 4.2847 13.5258 5.92356 15.3136C6.15052 15.5628 6.47606 15.7042 6.81276 15.7042C7.14946 15.7042 7.475 15.5628 7.70196 15.3136C9.34082 13.5258 13.1525 9.07238 13.1525 6.34163C13.1525 2.84433 10.3082 0 6.81276 0ZM7.35966 14.9991C7.21642 15.1535 7.02297 15.2391 6.81276 15.2391C6.60255 15.2391 6.4091 15.1536 6.26586 14.9991C4.66417 13.2525 0.93812 8.90875 0.93812 6.34167C0.93812 3.10103 3.57221 0.465067 6.81276 0.465067C10.0533 0.465067 12.6874 3.10103 12.6874 6.34167C12.6874 8.90875 8.96135 13.2524 7.35966 14.9991Z"/>
                                <path
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="blog-card2">
                    <div class="blog-img-wrap">
                        <a href="{{ isset($blogs[2]) ? route('frontsite.news.show', $blogs[2]->id) : 'javascript:void(0);' }}" class="blog-img">
                            @if(isset($blogs[2]) && $blogs[2]->image && file_exists(public_path('storage/' . $blogs[2]->image)))
                                <img src="{{ asset('storage/' . $blogs[2]->image) }}" alt="{{ $blogs[2]->title }}" style="min-height: 250px; object-fit: cover;">
                            @else
                                <img src="/frontsite-assets/img/packages/1.png" alt="" style="min-height: 250px">
                            @endif
                        </a>
                        <a href="{{ isset($blogs[2]) ? route('frontsite.news.show', $blogs[2]->id) : 'javascript:void(0);' }}" class="blog-date">
                            @if(isset($blogs[2]))
                                {{ \Carbon\Carbon::parse($blogs[2]->created_at)->format('d') }} <span>{{ \Carbon\Carbon::parse($blogs[2]->created_at)->format('M') }}.</span>
                            @else
                                07 <span>Feb.</span>
                            @endif
                        </a>
                    ...
                    <div class="blog-content">
                        <a href="{{ isset($blogs[2]) ? route('frontsite.news.show', $blogs[2]->id) : 'javascript:void(0);' }}" class="location">
                            <svg width="14" height="16" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M6.81276 0C3.31734 0 0.473053 2.84433 0.473053 6.34163C0.473053 9.07242 4.2847 13.5258 5.92356 15.3136C6.15052 15.5628 6.47606 15.7042 6.81276 15.7042C7.14946 15.7042 7.475 15.5628 7.70196 15.3136C9.34082 13.5258 13.1525 9.07238 13.1525 6.34163C13.1525 2.84433 10.3082 0 6.81276 0ZM7.35966 14.9991C7.21642 15.1535 7.02297 15.2391 6.81276 15.2391C6.60255 15.2391 6.4091 15.1536 6.26586 14.9991C4.66417 13.2525 0.93812 8.90875 0.93812 6.34167C0.93812 3.10103 3.57221 0.465067 6.81276 0.465067C10.0533 0.465067 12.6874 3.10103 12.6874 6.34167C12.6874 8.90875 8.96135 13.2524 7.35966 14.9991Z"/>
                                <path
        ...
        <div class="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="{{ route('frontsite.news.index') }}" class="primary-btn1 transparent">
                    <span>
