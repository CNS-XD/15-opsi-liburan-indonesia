...
<div class="home2-package-slider-section mb-100">
        ...
        <div class="row mb-40">
            <div class="col-lg-12">
                <div class="swiper home1-trip-slider">
                    <div class="swiper-wrapper">
                        @include('pages.frontsite.home._popular-packages')
                    </div>
                </div>
            </div>
        </div>
    ...
    <img src="/frontsite-assets/img/home2/vector/home2-package-slider-vector1.svg" alt="" class="vector1">
    <img src="/frontsite-assets/img/home2/vector/home2-package-slider-vector2.svg" alt="" class="vector2">
    <img src="/frontsite-assets/img/home2/vector/home2-package-slider-vector3.svg" alt="" class="vector3">
</div>
        ...
        <div class="service-wrapper two">
            <div class="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-lg-9">
                    <div class="section-title">
                        <h2>Opsi Liburan – Your Journey, Our Priority!</h2>
            ...
            <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <li class="single-service">
                    ...
                    <div class="content">
                        ...
                        <p>Instant tour booking with a simple, seamless process by Opsi Liburan</p>
                    </div>
                </li>
                <li class="single-service">
                    <div class="icon bg-warning">
                        <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 2C7.82 2 2 7.82 2 15s5.82 13 13 13 13-5.82 13-13S22.18 2 15 2zm1 21.5v1.5h-2v-1.5c-2.21-.41-4-1.92-4-4h2c0 1.1 1.34 2 3 2s3-.9 3-2-1.02-1.6-3.14-2.15C11.64 16.7 10 15.6 10 13.5c0-2.08 1.79-3.59 4-4V8h2v1.5c2.21.41 4 1.92 4 4h-2c0-1.1-1.34-2-3-2s-3 .9-3 2 1.02 1.6 3.14 2.15C18.36 16.3 20 17.4 20 19.5c0 2.08-1.79 3.59-4 4z"/>
                        </svg>
                    </div>
                    <div class="content">
                        <h4>Value For Money</h4>
                        <p>Affordable prices with quality services that truly match the experience.</p>
                    </div>
                </li>
                <li class="single-service">
                    <div class="icon bg-info">
            ...
            <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <li class="single-service">
                    <div class="icon bg-warning">
                        <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.5 2L5 17h7l-1.5 11L25 13h-7l-1.5-11z"/>
                        </svg>
                    </div>
                    <div class="content">
                        <h4>Fast Respond</h4>
                        <p>Quick responses to every inquiry, helping you plan your trip without delays.</p>
                    </div>
                </li>
                <li class="single-service">
                    <div class="icon bg-info">
                        <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 2C7.82 2 2 7.82 2 15s5.82 13 13 13 13-5.82 13-13S22.18 2 15 2zm-2.2 18.2L6.8 14.2l1.6-1.6 4.4 4.4 8.4-8.4 1.6 1.6-10 10z"/>
                        </svg>
                    </div>
                    <div class="content">
                        <h4>Hassle Free</h4>
                        <p>We simplify your journey so you can relax and enjoy every moment.</p>
                    </div>
                </li>
                <li class="single-service">
                    <div class="icon bg-warning">
                        <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 2C7.82 2 2 7.82 2 15s5.82 13 13 13 13-5.82 13-13S22.18 2 15 2zm-5 10a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm10 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm-5 7c-2.76 0-5-1.79-5-4h2c0 1.1 1.34 2 3 2s3-.9 3-2h2c0 2.21-2.24 4-5 4z"/>
                        </svg>
                    </div>
                    <div class="content">
                        <h4>Friendly Team</h4>
                        <p>Warm, helpful, and passionate local team ensuring a memorable experience.</p>
                    </div>
                </li>
            </ul>
            <div class="bottom-area d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div class="batch two">
                    <a href="javascript:void(0);">Discover Today
            ...
            <div class="swiper home2-destination-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/3.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Mount Bromo</a></h5>
                                <span>Tours (12)</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/10.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Ijen Crater</a></h5>
                                <span>Tours (5)</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/4.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Tumpak Sewu Waterfall</a></h5>
                                <span>Tours (16)</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/8.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Madakaripura Waterfall</a></h5>
                                <span>Tours (10)</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/11.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Taman Safari</a></h5>
                                <span>Tours (15)</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/12.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Surabaya City</a></h5>
                                <span>Tours (27)</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="destination-card2">
                            <a href="javascript:void(0);" class="destination-img">
                                <img src="/frontsite-assets/img/packages/13.jpg" style="height: 400px; width: 100%" alt="">
                            </a>
                            <div class="destination-content">
                                <h5><a href="javascript:void(0);">Malang City</a></h5>
                                <span>Tours (19)</span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row mb-60">
            <div class="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="about-content">
                    <div class="section-title">
                        <h2>Your Trustpoint, Opsi Liburan Best for Travel Agency.</h2>
                        <p><span>At Opsi Liburan Travel Agency, we are passionate about creating exceptional travel experiences.</span> Whether you're looking for a relaxing beach vacation, an adventurous trek, a luxurious getaway, or a cultural expedition.</p>
                    </div>
                    ...
                    <div class="row align-items-end g-xl-4 g-lg-2 g-4">
                        <div class="col-lg-6">
                            <div class="single-img">
                                <img src="/frontsite-assets/img/home2/about-img1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="single-img">
                                <img src="/frontsite-assets/img/home2/about-img2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="logo">
                        <img src="/frontsite-assets/img/logo.png" width="50px" alt="">
                    </div>
                    <svg class="vector" width="173" height="136" viewBox="0 0 173 136" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class="service-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <center>
                ...
                <div class="row justify-content-center text-center row-cols-xl-6 row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1 g-xxl-4 g-xl-3 g-lg-3 g-4">
                    <div class="col">
                    ...
                    <div class="col">
                            <div class="single-service">
                                ...
                                <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M13.2124 4.34912H16.7877V5.24913H13.2124V4.34912Z"/>
                                </svg>
                                Adventure <br> Travel
                            </a>
                        </div>
        ...
        <div class="rating-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <span>Excellent!</span>
            <img src="/frontsite-assets/img/home2/icon/trustpilot-star.svg" alt="">
            <div class="text-and-logo">
                <p>5.0 Rating out of 5.0 based on <span>24K+ reviews</span></p>
                <a href="http://trustpilot.com/"><img src="/frontsite-assets/img/home2/icon/trustpilot-logo.svg" alt=""></a>
            </div>
        </div>
    </div>
</div>
...
<!-- home2 one day trip Section Start-->
<div class="home2-oneday-trip-section mb-100">
    <div class="container">
        ...
        <div class="row g-4 mb-40">
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="package-card">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/9.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/7.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/3.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="package-content">
                        <h5><a href="javascript:void(0);">Mount Bromo Tour Package From Surabaya - 1 Day</a></h5>
                        <div class="location-and-time">
                            <div class="location">
                                ...
                                <a href="javascript:void(0);">from Surabaya</a>
                            </div>
                        </div>
                        <div class="btn-and-price-area">
                            <a href="javascript:void(0);" class="primary-btn1">
                                <span>
                                    Book Now
                                    <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="package-card">
                    <div class="package-img-wrap">
                        <a href="javascript:void(0);" class="package-img">
                            <img src="/frontsite-assets/img/packages/1.jpg" style="height: 300px; width: 100%;" alt="">
                        </a>
                    </div>
                    <div class="package-content">
                        <h5><a href="javascript:void(0);">Mount Bromo Sunrise Tour Package from Malang - 1 Day</a></h5>
                        <div class="location-and-time">
                            <div class="location">
                                <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <a href="javascript:void(0);">from Malang</a>
                            </div>
                        </div>
                        <div class="btn-and-price-area">
                            <a href="javascript:void(0);" class="primary-btn1">
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="package-card">
                    <div class="package-img-wrap">
                        <div class="swiper package-card-img-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/6.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/8.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                    ...
                    <div class="package-content">
                        <h5><a href="javascript:void(0);">Mount Bromo Sunrise - Madakaripura Waterfall Tour Package from Yogyakarta - 1 Day</a></h5>
                        <div class="location-and-time">
                            <div class="location">
                                <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <a href="javascript:void(0);">from Yogyakarta</a>
                            </div>
                        </div>
                        <div class="btn-and-price-area">
                            <a href="javascript:void(0);" class="primary-btn1">
        ...
        <div class="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="javascript:void(0);" class="primary-btn1 transparent">
                    <span>
                        View All Trips
                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path
...
<!-- home2 one day trip Section End-->

<!-- home2 offer banner Section Start-->
<div class="home2-offer-banner-section mb-100">
    <div class="container">
        <div class="offer-banner-wrap">
            ...
            <div class="offer-banner-img">
                <img src="/frontsite-assets/img/home2/home2-offer-banner-img.png" alt="">
            </div>
            <img src="/frontsite-assets/img/home2/vector/offer-banner-vector1.svg" alt="" class="vector1">
            <img src="/frontsite-assets/img/home2/vector/offer-banner-vector2.svg" alt="" class="vector2">
        </div>
    </div>
    <img src="/frontsite-assets/img/home2/vector/home2-offer-banner-vector.svg" alt="" class="vector">
</div>
        ...
        <div class="row gy-md-5 gy-4">
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="package-card">
                    <div class="package-img-wrap">
                        <div class="swiper package-card-img-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/10.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" class="package-img">
                                        <img src="/frontsite-assets/img/packages/2.jpg" style="height: 300px; width: 100%;" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="package-content">
                        <h5><a href="javascript:void(0);">Mount Bromo Sunrise and Mount Ijen Blue Fire Tour Package from Surabaya - 3 Days</a></h5>
                        <div class="location-and-time">
                            <div class="location">
                                <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="package-card">
                    <div class="package-img-wrap">
                        <a href="javascript:void(0);" class="package-img">
                            <img src="/frontsite-assets/img/packages/4.jpg" style="height: 300px; width: 100%;" alt="">
                        </a>
                    </div>
                    <div class="package-content">
                        <h5><a href="javascript:void(0);">Mount Bromo Sunrise and Tumpak Sewu Waterfall Tour Package from Surabaya - 3 Days</a></h5>
                        <div class="location-and-time">
                            <div class="location">
                                <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="package-card">
                    <div class="package-img-wrap">
                        <a href="javascript:void(0);" class="package-img">
                            <img src="/frontsite-assets/img/packages/1.jpg" alt="">
                        </a>
                    </div>
                    <div class="package-content">
                        <h5><a href="javascript:void(0);">Mount Bromo Sunrise, Madakaripura Waterfall, & Ijen Crater Blue Fire Tour Package from Surabaya - 3 Days</a></h5>
                        <div class="location-and-time">
                            <div class="location">
                                <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                    <path
...
<div class="home2-award-banner-section mb-100" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.25) 100%), url(/frontsite-assets/img/home2/home2-award-banner-bg.jpg);">
    <div class="container">
        <div class="banner-content">
            <div class="award-rating-area">
                <img src="/frontsite-assets/img/home2/travel-award.png" alt="">
                <h4>#1 Travel Agency in Indonesia</h4>
                <div class="rating">
                    <span>(</span>
                    <ul>
            ...
            <h3>Serving Travelers Worldwide</h3>
            <h2>BEST <span>BEST</span></h2>
            <span>Travel agency</span>
            <a href="javascript:void(0);" class="primary-btn1 two">
                <span>
                    View All Package
                    <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                        <path
...
<div class="home2-blog-section mb-100">
    <div class="container">
        <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-xl-6 col-lg-8">
                <div class="section-title text-center">
                ...
                <div class="blog-card2">
                    <div class="blog-img-wrap">
                        <a href="javascript:void(0);" class="blog-img">
                            <img src="/frontsite-assets/img/packages/3.png" alt="" style="min-height: 250px">
                        </a>
                    ...
                    <div class="blog-content">
                        ...
                        <h4><a href="javascript:void(0);">Top 10 Skills That Make a Tour Guide Truly Exceptional</a></h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="blog-card2">
                    <div class="blog-img-wrap">
                        <a href="javascript:void(0);" class="blog-img">
                            <img src="/frontsite-assets/img/packages/2.png" alt="" style="min-height: 250px">
                        </a>
                        <a href="javascript:void(0);" class="blog-date">
                            04 <span>Feb.</span>
                        </a>
                    ...
                    <div class="blog-content">
                        ...
                        <h4><a href="javascript:void(0);">How to Do Prewedding Photoshoot in Bromo, A Guide for Brides</a></h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="blog-card2">
                    <div class="blog-img-wrap">
                        <a href="javascript:void(0);" class="blog-img">
                            <img src="/frontsite-assets/img/packages/1.png" alt="" style="min-height: 250px">
                        </a>
                        <a href="javascript:void(0);" class="blog-date">
                            07 <span>Feb.</span>
                        </a>
                    ...
                    <div class="blog-content">
                        ...
                        <h4><a href="javascript:void(0);">10 Best Things to Do in Surabaya: Your Friendly Guide to Unforgettable Experiences!</a></h4>
                    </div>
                </div>
            </div>
        </div>
...
<div class="home2-testimonial-section">
    <div class="container">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-card three">
                                ...
                                <p>
                                    Had an amazing tour with a very friendly and supportive guide. Even though the hike was challenging, the guide patiently helped every step. Truly a fun and memorable experience! 😉
                                </p>
                                <div class="author-area">
                                    <div class="author-img">
                                        <img src="/frontsite-assets/img/home1/testimonial-author-img1.png" alt="">
                                    </div>
        ...
        <div class="review-and-slider-btn wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <a href="javascript:void(0);" class="single-rating">
                <strong>4.9</strong>
                <div class="trustpilot-rating">
                    {{-- <img src="/frontsite-assets/img/home1/icon/trustpilot-logo.svg" alt=""> --}}
                    <div class="rating-area">
                        <img src="/frontsite-assets/img/home1/icon/trustpilot-star.svg" alt="">
            ...
            {{-- <a href="https://www.tripadvisor.com/" class="single-rating">
                ...
                <div class="tripadvisor-rating">
                    <img src="/frontsite-assets/img/home1/icon/tripadvisor-logo.svg" alt="">
                    <div class="rating-area">
                        <span>Reviews</span>
                        <img src="/frontsite-assets/img/home1/icon/tripadvisor-start.svg" alt="">
                    </div>
                </div>
            </a> --}}
        </div>
        ...
        <div class="row gy-md-5 gy-4">
            <div class="col-lg-3 col-sm-6 divider">
                ...
                <svg class="line" width="6" height="215" viewBox="0 0 6 215" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 5L5.88675 0H0.113249L2.5 5H3.5ZM2.5 210L0.113249 215H5.88675L3.5 210H2.5ZM2.5 4.5V210.5H3.5V4.5H2.5Z"/>
                </svg>
            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-7 mt-70">
                            <div class="single-img justify-content-md-end">
                                <a data-fancybox="gallery-01" href="/frontsite-assets/img/home2/gallery-img1-big.jpg">
                                    <img src="/frontsite-assets/img/home2/gallery-img1.jpg" alt="">
                                </a>
                            </div>
                            <div class="single-img justify-content-md-end">
                                <a data-fancybox="gallery-01" href="/frontsite-assets/img/home2/gallery-img2-big.jpg">
                                    <img src="/frontsite-assets/img/home2/gallery-img2.jpg" alt="">
                                </a>
                            </div>
                            <div class="single-img justify-content-md-between">
                                ...
                                <a data-fancybox="gallery-01" href="/frontsite-assets/img/home2/gallery-img3-big.jpg">
                                    <img src="/frontsite-assets/img/home2/gallery-img3.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="single-img grp-img">
                                <a data-fancybox="gallery-01" href="/frontsite-assets/img/home2/gallery-img4-big.jpg">
                                    <img src="/frontsite-assets/img/home2/gallery-img4.jpg" alt="">
                                </a>
                                <a data-fancybox="gallery-01" href="/frontsite-assets/img/home2/gallery-img5-big.jpg">
                                    <img src="/frontsite-assets/img/home2/gallery-img5.jpg" alt="">
                                </a>
                            </div>
                            <div class="single-img">
                                <a data-fancybox="gallery-01" href="/frontsite-assets/img/home2/gallery-img6-big.jpg">
                                    <img src="/frontsite-assets/img/home2/gallery-img6.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="icon">
                        <img src="/frontsite-assets/img/logo-white.png" alt="Logo Opsi Liburan" width="60px">
