            ...
            <div class="footer-contact-wrap">
                ...
                <ul class="contact-area">
                    <li class="single-contact">
                        <div class="icon">
                            <img src="/frontsite-assets/img/home1/icon/whatsapp-icon2.svg" alt="">
                        </div>
                        <div class="content">
                            <span>WhatsApp</span>
                    ...
                    <li class="single-contact">
                        <div class="icon">
                            <img src="/frontsite-assets/img/home1/icon/mail-icon2.svg" alt="">
                        </div>
                        <div class="content">
                            <span>Mail Us</span>
                            <span>
                    ...
                    <li class="single-contact">
                        <div class="icon">
                            <img src="/frontsite-assets/img/home1/icon/call-icon.svg" alt="">
                        </div>
                        <div class="content">
                            <span>Call Us</span>
                ...
                <div class="copyright-and-payment-method-area">
                    ...
                    <div class="payment-method-area">
                        ...
                        <ul>
                            ...
                            <li><img src="/frontsite-assets/img/home1/icon/paypal-icon.svg" alt=""></li>
                            <li><img src="/frontsite-assets/img/home1/icon/gpay-icon.svg" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
