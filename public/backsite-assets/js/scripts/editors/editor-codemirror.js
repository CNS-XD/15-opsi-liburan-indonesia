...
(function (window, document, $) {
  ...
  $('#select').change(function () {
    ...
    stylesheet.attr('href', '../../../backsite-assets/vendors/css/editors/theme/' + selectedTheme.toLowerCase() + '.css');
  ...
  CodeMirror.modeURL = "../../../backsite-assets/vendors/js/editors/codemirror/mode/*/*.js";
