...
$(document).ready(function () {
  ...
  // Koordinat untuk Dusun Karang Nongko, Desa Sumber Karang, Dlanggu, Mojokerto, Jawa Timur
  var mapsLeafletBasic = L.map('maps-leaflet-basic').setView([-7.5756, 112.4723], 15);
  ...
  L.marker([-7.5756, 112.4723]).addTo(mapsLeafletBasic)
    .bindPopup("Dusun Karang Nongko, Desa Sumber Karang, Dlanggu, Mojokerto, Jawa Timur")
    .openPopup();
